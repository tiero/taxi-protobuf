...
type TopupWithAssetReply struct {
	...
	BlindingKey string `protobuf:"bytes,3,opt,name=blinding_key,json=blindingKey,proto3" json:"blinding_key,omitempty"` // the hex encoded blinding private key of the locked LBTC input
}
...
func (x *TopupWithAssetReply) GetBlindingKey() string {
	if x != nil {
...
var file_taxi_proto_rawDesc = []byte{
	...
	0x50, 0x65, 0x72, 0x42, 0x79, 0x74, 0x65, 0x22, 0x6e, 0x0a, 0x13, 0x54, 0x6f, 0x70, 0x75, 0x70,
	...
	0x70, 0x69, 0x72, 0x79, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67,
	0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x62, 0x6c, 0x69, 0x6e,
